...
/**
 * @brief range image visualization param
 *
 */
...
/**
 * @brief Set the Viewer Pose object
 *
 * @param viewer
 * @param viewer_pose
 */
...
int main(int argc, char **argv)
{
    ...
    /**
     * @brief Read pcd file or create example point cloud if not given
     * 
     */
    ...
    /**
     * @brief Create RangeImage from the PointCloud
     * 
     */
