 ...
 * 
 */
double VoxelGridLeafSize(0.001);  // default: 0.05
int NormEstKSearch(100);         // default: 30
double ICPMaxDist(2.0);         // default: 0.1
...
/**
 * @brief custom pointcloud struct
 * 
 */
struct PCD
{
...
/**
 * @brief struct to compare PCD f_name
 * 
 */
...
/**
 * @brief class MyPointRepresentation
 * Define a new point representation for < x, y, z, curvature >
 * 从父类pcl::PointRepresentation中继承
 */
...
public:
    ...
    // 父类中copyToFloatArray是纯虚函数, 需要在子类中被实现
...
{
    /**
     * @brief Downsample for consistency and speed
    ...
    // init custom point representation
